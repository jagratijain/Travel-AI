          ...
          <div className="-mx-4 flex flex-wrap items-center justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                Travel with us and embrace sustainable exploration. Discover unforgettable destinations while leaving positive impacts—take only memories, leave behind the natural beauty for future travelers to enjoy.
                </p>
                <p className="text-body-color mb-12 text-base">
                Our AI-powered platform offers personalized travel experiences that minimize environmental footprints. Join us in preserving the planet, ensuring each journey enriches both traveler and environment alike.
                </p>
              </div>
            </div>

          ...
          <div className="-mx-4 flex flex-wrap items-center justify-between">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <h2 className="text-dark mb-8 text-2xl font-bold sm:text-3xl">
                Smart. Personalized. Effortless. Reliable
                </h2>
                <p className="text-body-color mb-8 text-base">
                Embark on a transformative travel experience with our cutting-edge platform integrating artificial intelligence. Discover new horizons with intelligent recommendations and insights, ensuring each trip is not just a vacation, but an adventure redefined.
                </p>
                <p className="text-body-color mb-12 text-base">
                
                From effortless booking of personalized travel packages to AI-powered exploration of destinations, we offer a seamless journey tailored to your preferences.
                </p>
              </div>
            </div>
          </div>
